...
const testimonials = [
  {
    quote: "Petal has transformed how Afsar Developers evaluates projects. Their platform helps us analyze opportunities, understand zoning, and make confident decisions while saving us months of work. By turning complex data into clear recommendations, Petal allows our team to move faster, reduce risk, and focus on the projects that matter most.",
    name: "Hasan Syed",
    position: "Partner",
