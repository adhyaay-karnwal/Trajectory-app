...
import { AgentChatDemo } from "@/components/welcome/onboarding-demos";
          ...
          <div className="absolute bottom-1 left-1 right-1 bg-white dark:bg-[#1c1c1c] dark:border dark:border-gray-600 rounded-lg p-4">
            <div className="mb-3">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-manrope text-sm">
                Your intelligent mission planner. It helps you select destinations, choose spacecraft, configure crew, and plan your budget—all grounded in real mission data.
              </p>
            </div>
            <div className="flex justify-between items-center">
              <Link href="/welcome/02">
