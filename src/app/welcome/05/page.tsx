...
import { ProformaAIDemo } from "@/components/welcome/onboarding-demos";
import { OnboardingProgress } from "@/components/welcome/onboarding-progress";

export default function Onboarding05Page() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (e.key === "Escape") {
        window.location.href = "/welcome/04";
      }
    };
    ...
    const handleKeyUp = (e: KeyboardEvent) => {
      if (e.key === "Enter") {
        setPressedKey(null);
        window.location.href = "/welcome/06";
      }
    };
          ...
          <div className="absolute bottom-1 left-1 right-1 bg-white dark:bg-[#1c1c1c] dark:border dark:border-gray-600 rounded-lg p-4">
            <div className="mb-3">
              <h1 className="text-lg font-canela font-semibold text-black dark:text-white mb-1">
                Mission plans built in seconds.
              </h1>
              <p className="text-gray-600 dark:text-gray-400 font-manrope text-sm">
                Tell the AI your mission goals. It configures spacecraft, calculates launch windows, and optimizes your trajectory automatically.
              </p>
            </div>
            <div className="flex justify-between items-center">
              <Link href="/welcome/04">
