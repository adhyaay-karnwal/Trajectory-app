...
I should also explore workflow outputs. Nura can take all this raw data and generate natural language feasibility summaries and structured reports.
...
const toolCalls = [
  "*Nura querying LoopNet for comps...*",
